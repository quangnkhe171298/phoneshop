<%-- 
    Document   : home
    Created on : Sep 26, 2023, 7:59:25 PM
    Author     : kiemq
--%>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        <h1 class="title text-white">${c.title}</h1>
                                        <h4 class="subtitle text-white">${c.description} </h4>
                    ...
                    <div class="col-12">
                        <div class="section-content-gap">
                            <div class="secton-content">
                                <h3  class="section-title">the featured products</h3>
...
<!--                                                    <a href="compare.html"><i class="icon-shuffle"></i></a>-->
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-default.html">${pro.getTitle()}</a></h6>
                                            ...
                                            <div class="content-right">
                                                <span class="price"><span>$</span>${pro.getPrice()}</span>
                                                <del><span class="price"><span>$</span>${pro.getSalePrice()}</span></del>
                                            </div>
                            ...
                            <div class="swiper-container blog-slider">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="blog-default-single-item blog-color--pink swiper-slide">
                                        ...
                                        <div class="content">
                                            <h6 class="title"><a href="blog-single-sidebar-left.html">${pro.blog_title}</a></h6>
                                            <p>${pro.description}....</p>
                                            <div class="inner">
                ...
                <div class="col-lg-3 col-sm-6 mb-6">
                    ...
                    <div class="footer-widget-single-item footer-widget-color--pink" data-aos="fade-up"  data-aos-delay="600">
                        ...
                        <div class="footer-about">
                            ...
                            <address>
                                 <span>Address: Hoa Lac</span> <br/>
                                 <span>Email: teamhono@gmail.com</span>    
                            </address>
                        </div>
                    </div>
                      <!-- End Footer Single Item -->
                                ...
                                <div class="product-details-gallery-area mb-7">
                                    ...
                                    <div class="product-image-thumb modal-product-image-thumb swiper-container pos-relative mt-5">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="product-image-thumb-single swiper-slide">
                                                    <img class="img-fluid" src="assets/images/product/default/home-3/default-2.jpg" alt="">
                                                </div>
                                                <div class="product-image-thumb-single swiper-slide">
                                                    <img class="img-fluid" src="assets/images/product/default/home-3/default-3.jpg" alt="">
                                                </div>
                                                <div class="product-image-thumb-single swiper-slide">
                                                    <img class="img-fluid" src="assets/images/product/default/home-3/default-4.jpg" alt="">
                                                </div>
                                                <div class="product-image-thumb-single swiper-slide">
                                                    <img class="img-fluid" src="assets/images/product/default/home-3/default-5.jpg" alt="">
                                                </div>
                                                <div class="product-image-thumb-single swiper-slide">
                                                    <img class="img-fluid" src="assets/images/product/default/home-3/default-6.jpg" alt="">
                                                </div>
                                        </div>
                                        <!-- Add Arrows -->
